...
def calculate_sparsity(model):
    spar=100. * float( torch.sum(model.conv1.weight == 0)
                + torch.sum(model.layer1[0].conv1.weight == 0)
                + torch.sum(model.layer1[0].conv2.weight == 0)
                + torch.sum(model.layer1[0].conv3.weight == 0)
                + torch.sum(model.layer1[0].downsample[0].weight == 0)
                + torch.sum(model.layer1[1].conv1.weight == 0)
                + torch.sum(model.layer1[1].conv2.weight == 0)
                + torch.sum(model.layer1[1].conv3.weight == 0)
                + torch.sum(model.layer1[2].conv1.weight == 0)
                + torch.sum(model.layer1[2].conv2.weight == 0)
                + torch.sum(model.layer1[2].conv3.weight == 0)
                + torch.sum(model.layer2[0].conv1.weight == 0)
                + torch.sum(model.layer2[0].conv2.weight == 0)
                + torch.sum(model.layer2[0].conv3.weight == 0)
                + torch.sum(model.layer2[0].downsample[0].weight == 0)
                + torch.sum(model.layer2[1].conv1.weight == 0)
                + torch.sum(model.layer2[1].conv2.weight == 0)
                + torch.sum(model.layer2[1].conv3.weight == 0)
                + torch.sum(model.layer2[2].conv1.weight == 0)
                + torch.sum(model.layer2[2].conv2.weight == 0)
                + torch.sum(model.layer2[2].conv3.weight == 0)
                + torch.sum(model.layer2[3].conv1.weight == 0)
                + torch.sum(model.layer2[3].conv2.weight == 0)
                + torch.sum(model.layer2[3].conv3.weight == 0)
                + torch.sum(model.layer3[0].conv1.weight == 0)
                + torch.sum(model.layer3[0].conv2.weight == 0)
                + torch.sum(model.layer3[0].conv3.weight == 0)
                + torch.sum(model.layer3[0].downsample[0].weight == 0)
                + torch.sum(model.layer3[1].conv1.weight == 0)
                + torch.sum(model.layer3[1].conv2.weight == 0)
                + torch.sum(model.layer3[1].conv3.weight == 0)
                + torch.sum(model.layer3[2].conv1.weight == 0)
                + torch.sum(model.layer3[2].conv2.weight == 0)
                + torch.sum(model.layer3[2].conv3.weight == 0)
                + torch.sum(model.layer3[3].conv1.weight == 0)
                + torch.sum(model.layer3[3].conv2.weight == 0)
                + torch.sum(model.layer3[3].conv3.weight == 0)
                + torch.sum(model.layer3[4].conv1.weight == 0)
                + torch.sum(model.layer3[4].conv2.weight == 0)
                + torch.sum(model.layer3[4].conv3.weight == 0)
                + torch.sum(model.layer3[5].conv1.weight == 0)
                + torch.sum(model.layer3[5].conv2.weight == 0)
                + torch.sum(model.layer3[5].conv3.weight == 0)
                + torch.sum(model.layer4[0].conv1.weight == 0)
                + torch.sum(model.layer4[0].conv2.weight == 0)
                + torch.sum(model.layer4[0].conv3.weight == 0)
                + torch.sum(model.layer4[0].downsample[0].weight == 0)
                + torch.sum(model.layer4[1].conv1.weight == 0)
                + torch.sum(model.layer4[1].conv2.weight == 0)
                + torch.sum(model.layer4[1].conv3.weight == 0)
                + torch.sum(model.layer4[2].conv1.weight == 0)
                + torch.sum(model.layer4[2].conv2.weight == 0)
                + torch.sum(model.layer4[2].conv3.weight == 0)
                + torch.sum(model.fc.weight == 0)
            )/ float(
                model.conv1.weight.nelement()
                + model.layer1[0].conv1.weight.nelement()
                + model.layer1[0].conv2.weight.nelement()
                + model.layer1[0].conv3.weight.nelement()
                + model.layer1[0].downsample[0].weight.nelement()
                + model.layer1[1].conv1.weight.nelement()
                + model.layer1[1].conv2.weight.nelement()
                + model.layer1[1].conv3.weight.nelement()
                + model.layer1[2].conv1.weight.nelement()
                + model.layer1[2].conv2.weight.nelement()
                + model.layer1[2].conv3.weight.nelement()
                + model.layer2[0].conv1.weight.nelement()
                + model.layer2[0].conv2.weight.nelement()
                + model.layer2[0].conv3.weight.nelement()
                + model.layer2[0].downsample[0].weight.nelement()
                + model.layer2[1].conv1.weight.nelement()
                + model.layer2[1].conv2.weight.nelement()
                + model.layer2[1].conv3.weight.nelement()
                + model.layer2[2].conv1.weight.nelement()
                + model.layer2[2].conv2.weight.nelement()
                + model.layer2[2].conv3.weight.nelement()
                + model.layer2[3].conv1.weight.nelement()
                + model.layer2[3].conv2.weight.nelement()
                + model.layer2[3].conv3.weight.nelement()
                + model.layer3[0].conv1.weight.nelement()
                + model.layer3[0].conv2.weight.nelement()
                + model.layer3[0].conv3.weight.nelement()
                + model.layer3[0].downsample[0].weight.nelement()
                + model.layer3[1].conv1.weight.nelement()
                + model.layer3[1].conv2.weight.nelement()
                + model.layer3[1].conv3.weight.nelement()
                + model.layer3[2].conv1.weight.nelement()
                + model.layer3[2].conv2.weight.nelement()
                + model.layer3[2].conv3.weight.nelement()
                + model.layer3[3].conv1.weight.nelement()
                + model.layer3[3].conv2.weight.nelement()
                + model.layer3[3].conv3.weight.nelement()
                + model.layer3[4].conv1.weight.nelement()
                + model.layer3[4].conv2.weight.nelement()
                + model.layer3[4].conv3.weight.nelement()
                + model.layer3[5].conv1.weight.nelement()
                + model.layer3[5].conv2.weight.nelement()
                + model.layer3[5].conv3.weight.nelement()
                + model.layer4[0].conv1.weight.nelement()
                + model.layer4[0].conv2.weight.nelement()
                + model.layer4[0].conv3.weight.nelement()
                + model.layer4[0].downsample[0].weight.nelement()
                + model.layer4[1].conv1.weight.nelement()
                + model.layer4[1].conv2.weight.nelement()
                + model.layer4[1].conv3.weight.nelement()
                + model.layer4[2].conv1.weight.nelement()
                + model.layer4[2].conv2.weight.nelement()
                + model.layer4[2].conv3.weight.nelement()
...
def train(
    ...
    if args.pruning is True:
        ...
        begin_pruning_step=21000 ,
        end_pruning_step=-1,
        policy_begin_step=21000,
        policy_end_step=63000,
        pruning_fn="unstructured_magnitude",
        pruning_fn_default_kwargs={"target_sparsity": args.sparsity_ratio}
        )
        print(pruning_config)
    ...
    for epoch in range(epoch_offset, epoch_offset + args.n_epochs):
        ...
        if(args.pruning):
            global_sparsity=calculate_sparsity(model=model)
            with open(args.log_dir+'/sparsity_with_epoch.txt','a') as f:
                f.write(str(epoch)+': '+str(global_sparsity)+'\n')
